...
const props=defineProps<{conversationId:string;taskId?:string}>()
...
<template>
 <section class="inspector" aria-label="Inspector 请求查看器">
  <header><AppIcon name="bug" :size="16"/><strong>Inspector</strong></header>
