    ...
    <div ref="scroller" class="timeline" @scroll.passive="onScroll"
      ...
      <div v-else class="message-stack">
        ...
        <article
          ...
          :key="message.id"
          v-memo="[message, showTools, showAssistantIdentity, mentionSignature, agentAvatars[message.profile || ''], avatarState(message), copiedMessageId === message.id, copyFailedMessageId === message.id, readOnly, allowBranch]"
