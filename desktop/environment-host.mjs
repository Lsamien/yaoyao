...
export class DesktopHostCore {
 ...
 async close(){this.closed=true;powerMonitor.removeListener('lock-screen',this.onLock);powerMonitor.removeListener('unlock-screen',this.onUnlock);await this.recycle()}
}
